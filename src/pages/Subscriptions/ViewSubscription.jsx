                  ...
                  <Card>
                    <CardContent>
                      ...
                      <Grid container spacing={2} columnSpacing={10}>
                        ...
                        <Grid item xs={7} >
                          <Box className='content'>
                            <Typography fontFamily='Asap'><b style={{paddingRight:'220px'}}>Subscription Information</b>
                            ...
                            <div className='infodesc'>
                              <p style={{paddingBottom:'25px',paddingTop:'15px'}}>{val.description}</p>

                              <div style={{fontSize:'13px',lineHeight:'2.4'}}>
                              <p><span style={{color:'black'}}><b>Contact person :    </b> </span>{val.owner}</p>
                              <p><span style={{color:'black'}}><b>Mobile  :   </b> </span>{val.contactNo}</p>
                              <p><span style={{color:'black'}}><b>Email  :    </b> </span>{val.email}</p>
                              <p><span style={{color:'black'}}><b>Location  :    </b> </span>{val.location}</p>
                              <p style={{color:'black'}}><b>Social  :  </b></p>
                               
                               <a style={{paddingRight:'10px'}} href={val.facebook} target='_blank'> <Facebook sx={{ fontSize: 20 }}/></a>
                               <a style={{paddingRight:'10px'}} href={val.LinkedIn} target='_blank'><LinkedIn sx={{ fontSize: 20 }}/></a>
                               <a  style={{paddingRight:'10px'}} href={val.Instagram} target='_blank'><Instagram sx={{ fontSize: 20 }}/></a>
                               <a  style={{paddingRight:'10px'}} href={val.WebsiteURL} target='_blank'><Language sx={{fontSize:20}}/></a>
                              </div>
                            </div>
                                  ...
                                  return(
                                    <>
                                      <Grid container spacing={3} style={{paddingTop:'10px'}}>
                                        ...
                                        <Grid item xs={5}>
                                        <span className='userinfo'><b>{tdata.name}</b> <br/>
                                        <p style={{color:'grey'}}>{tdata.type}</p>
                                        </span>
                                        </Grid>

                                        <Grid item xs={5}>
                                        <div className='userinfo'>{tdata.category}</div>
                                        </Grid>
                                      </Grid>
                                    </>
                                  )
                      ...
                      <Box style={{paddingLeft:'10px'}}>
                        <Typography fontFamily='Asap' ><b>Sites</b></Typography>
